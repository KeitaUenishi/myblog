...
editedAt: null
description: "プロパティとは クラス外部から見るとメンバー変数のようにふるまい、クラス内部から見るとメソッドのようにふるまうもの。 JavaやC++はこの機能を持っていない。Cが持つ便利な機能。 - プロパティ:"
tags:
  - C#
  - プログラミング
---
...
**（現在の最新はC# 10 **[**https://learn.microsoft.com/ja-jp/dotnet/csharp/whats-new/csharp-10?source=recommendations）**](https://learn.microsoft.com/ja-jp/dotnet/csharp/whats-new/csharp-10)
