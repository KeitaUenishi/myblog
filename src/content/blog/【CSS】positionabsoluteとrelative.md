---
title: "【CSS】positionabsoluteとrelative"
id: t6b9glk
public: true
publishedAt: 2022-04-20
editedAt: null
description: "はじめに この記事は、HTML、CSSを書くときにいつも「なんだっけ……？」となるpositionプロパティについて、自分なりに調べたことをまとめています。 positionプロパティとは 要素を配置"
tags:
  - CSS
---
...
それぞれ、全て使用する必要はなく、pxや%などで指定することができます。値を指定しない場合は**top: 0;** と **left: 0;** が自動的に適用されます。 すでに設定した値をリセットする場合はautoを入力します。

![](_images/Untitled%2033.png)
...
[https://codesandbox.io/s/headless-shadow-8fucl8?from-embed](https://codesandbox.io/s/headless-shadow-8fucl8?from-embed)
...
[https://codesandbox.io/s/friendly-mcnulty-z6u72z?from-embed](https://codesandbox.io/s/friendly-mcnulty-z6u72z?from-embed)

## いろいろ動かしてみると…

以下の画像のように、absoluteを指定した赤色の要素は、同じくrelativeを指定した緑色の要素に比べて若干位置が違うように見えます。

![](_images/Untitled%2034.png)

どちらもtopとleftを0にしてみると……

![](_images/Untitled%2035.png)

赤の要素はブラウザの一番左上を基準にし、緑の要素は少し空白があることがわかります。

position: absoluteは親要素にposition: static以外の値がなければ、ウィンドウの左上が基準となります。

その逆として、親要素にposition: static以外の値（relativeなど）を設定すると、その親要素が基準になります。 この場合、以下のように親要素にposition: relativeを指定してみると……

![](_images/Untitled%2036.png)

ピッタリと重なりました！

後ろに隠れたんじゃなくてなくなったんじゃねぇだろおなぁという方。 安心してください。ちゃんといますよ。

![](_images/Untitled%2037.png)
...
[https://www.asobou.co.jp/blog/web/css-position](https://www.asobou.co.jp/blog/web/css-position)

[https://qiita.com/sun19008/items/b18b2dc98443ab988ecb](https://qiita.com/sun19008/items/b18b2dc98443ab988ecb)
